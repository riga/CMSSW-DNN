...
This interface requires CMSSW 9.4.X or greater and TensorFlow 1.3 (currently version in `slc6_amd64_gcc630`). There are other versions of this interface, depending on which TensorFlow version/API is available:

- TF C++ API v1.5: [tf_cc_1.3 branch](/../tree/tf_cc_1.3) (currently works only in latest IBs)
